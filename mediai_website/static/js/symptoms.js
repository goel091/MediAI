/* symptoms.js — Diagnose page: symptom selection & navigation to result */
'use strict';
...
const CAT = {
  ...
  gastro: ['vomiting','nausea','diarrhoea','stomach','indigestion','acidity','constipation','appetite','hunger','bowel','anal','passage_of_gas','belly','ulcer','bleeding','distention'],
  ...
  resp:   ['cough','breathless','phlegm','sputum','congestion','sinus','throat','runny','chest_pain','asthma'],
};
...
async function goPredict(){
  ...
  // Store symptoms in sessionStorage for result page
  sessionStorage.setItem('mediai_symptoms', JSON.stringify(syms));
